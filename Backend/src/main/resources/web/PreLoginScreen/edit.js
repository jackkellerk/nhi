...
function startPreLogin()
{
    ...
    windowContainer.removeChild(login_hex.container);
    ...
    signUpContainer.alpha = 0;
    windowContainer.addChild(signUpContainer);
    windowContainer.addChild(login_UI);
    ...
    windowContainer.removeChild(signup_hex.container);
    ...
    windowContainer.addChild(SU_loginText);
    ...
    windowContainer.addChild(signUp_UI);
