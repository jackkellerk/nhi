        ...
        function LI_showAll() {
            const IndexText = new PIXI.Text("Hello Test Text", LI_style);
        ...
        /**
         * As of now this doesn't do anything but it can be used to show a 
        ...
        /**
         * Similar situation to draw down so this could be used to activate a
